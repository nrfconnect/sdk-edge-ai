...
The Data Forwarder Host is a cross-platform desktop GUI for receiving, visualizing, recording, and exporting sensor data from a device running :ref:`Data Forwarder sample <data_forwarder_sample>` over UART or :ref:`nrf:nus_service_readme`.
