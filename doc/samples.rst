...
The |EAI| repository provides samples and tests showcasing its functionality.
You can build them for a variety of board targets and configure them for different usage scenarios.

Samples are in the :file:`samples` directory, and tests are in the :file:`tests` directory.
...
* :ref:`axon_samples` - Run models on the Axon NPU, including low-power operation, and validate Axon functionality with dedicated tests.
