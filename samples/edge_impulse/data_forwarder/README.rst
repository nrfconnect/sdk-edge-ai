...
.. note::
   Starting from the |EAI| release v2.2.0, this sample is deprecated and will be removed in a future |EAI| release.
   It is recommended to base your application on the :ref:`data_forwarder_sample`, which also supports the format accepted by `Edge Impulse's data forwarder`_.
...
The sample forwards simulated accelerometer data generated by :ref:`nrf:sensor_sim`.
