...
#ifndef _NRF_EDGEAI_USER_MODEL_90449_H_
#define _NRF_EDGEAI_USER_MODEL_90449_H_
 ...
 *
 * Only valid to call after a successful nrf_edgeai_load_user_model_90449() - use that instead
...
#if defined(CONFIG_MODEL_OTA_NEUTON)
#define nrf_edgeai_user_model nrf_edgeai_load_user_model_90449
#else
#define nrf_edgeai_user_model nrf_edgeai_user_model_90449
#endif
#endif
...
#define nrf_edgeai_user_model_neuton_size nrf_edgeai_user_model_neuton_size_90449
#endif
...
#endif /* _NRF_EDGEAI_USER_MODEL_90449_H_ */
