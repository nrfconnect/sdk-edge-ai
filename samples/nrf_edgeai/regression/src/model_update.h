...
/** MCUboot updateable image index for the regression model. */
#define REGRESSION_MODEL_IMAGE_INDEX 1
...
/** True while a regression model SMP upload is active or pending reset. */
bool model_update_blocks_inference(void);

/** True after a model SMP upload finished and a reset is required. */
