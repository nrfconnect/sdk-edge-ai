...
const NRF_AXON_PLATFORM_BITWIDTH_UNSIGNED_TYPE cmd_buffer_hello_axon[70] = {
// segment 0,length 68,Axon NN
0x1fff0044,0x00000046,
...
#define NRF_AXON_MODEL_HELLO_AXON_INPUT_VECTOR_CNT 1
NRF_AXON_MODEL_APP_STORAGE const int8_t *hello_axon_input_vector_list[NRF_AXON_MODEL_HELLO_AXON_INPUT_VECTOR_CNT];
...
NRF_AXON_MODEL_APP_STORAGE uint32_t hello_axon_packed_output_buf[NRF_AXON_MODEL_HELLO_AXON_PACKED_OUTPUT_SIZE/sizeof(uint32_t)];
#endif
...
#if NRF_AXON_MODEL_ALLOCATE_PACKED_OUTPUT_BUFFER
    .packed_output_buf = (int8_t *)hello_axon_packed_output_buf,
#endif
