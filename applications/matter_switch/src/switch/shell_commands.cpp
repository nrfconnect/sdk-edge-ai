...
Switch *sSwitchInstance = nullptr;
...
namespace Unicast
{
	...
	static CHIP_ERROR OnCommandHandler(int argc, char **argv)
	{
		...
		if (data) {
			data->EndpointId = sSwitchInstance->GetSwitchEndpointId();
			data->CommandId = Clusters::OnOff::Commands::On::Id;
			data->ClusterId = Clusters::OnOff::Id;
			data->InvokeCommandFunc = sSwitchInstance->SwitchChangedHandler;
...
{
	if (switchInstance) {
		sSwitchInstance = switchInstance;
	} else {
		LOG_ERR("Switch instance is null");
		return;
	}
