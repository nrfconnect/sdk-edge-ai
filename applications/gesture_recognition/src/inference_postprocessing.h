 ...
 * @param[in] do_postprocessing If false, no postprocessing is applied and
 *                              the raw prediction goes to the user callback
 *                              unchanged
 * @param[in] callback          Inference Result (prediction) ready user
 *                              callback, @ref inference_postprocess_cb_t
 */
