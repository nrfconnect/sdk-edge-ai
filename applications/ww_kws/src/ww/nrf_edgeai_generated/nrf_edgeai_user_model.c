...
#if defined(CONFIG_APP_MODEL_OTA)
nrf_axon_nn_compiled_model_s model_axon_user_instance_36711_runtime_;
int32_t axon_model_axon_user_instance_36711_persistent_vars[CONFIG_APP_WW_PERSISTENT_VARS_SIZE];
#define P_MODEL_INSTANCE &model_axon_user_instance_36711_runtime_
#else
...
{
	if (model_pkg_load_axon(fa_id, partition_addr, &model_axon_user_instance_36711_runtime_,
				 NULL) != MODEL_PKG_OK) {
		return NULL;
	}
