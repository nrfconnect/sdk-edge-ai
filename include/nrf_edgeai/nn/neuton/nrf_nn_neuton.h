...
typedef struct nrf_nn_neuton_model_meta_s {
	const uint16_t
		*p_neuron_internal_links_num; /**< Number of internal links for each neuron */
	const uint16_t
		*p_neuron_external_links_num;	  /**< Number of external links for each neuron */
...
/** @brief Run inference for 8-bit quantized Neuton model,
 * results of inferece are stored in p_model->p_neurons
 *
...
/** @brief Run inference for 16-bit quantized Neuton model,
 * results of inferece are stored in p_model->p_neurons
 *
...
/** @brief Run inference for 32-bit floating point Neuton model,
 * results of inferece are stored in p_model->p_neurons
 *
...
/** @brief Run inference with raw arguments for 32-bit floating point Neuton model, results of
 * inferece are stored in p_neurons
 *
...
/** @brief Run inference with raw arguments for 8-bit quantized Neuton model, results of inferece
 * are stored in p_neurons
 *
 * @param[in, out] p_neurons                  Pointer to neurons buffer
 * @param[in]     neurons_num                 Number of neurons in the model
 * @param[in]     p_neuron_links              Pointer to neuron links array
...
/** @brief Run inference with raw arguments for 16-bit quantized Neuton model, results of inferece
 * are stored in p_neurons
 *
 * @param[in, out] p_neurons                  Pointer to neurons buffer
 * @param[in]     neurons_num                 Number of neurons in the model
