...
/**
 * @brief Time-domain features ID, should be kept in the same order as in
 * nrf_edgeai_features_stat_mask_t
 */
...
/**
 * @brief Frequency-domain features ID, should be kept in the same order as in
 * nrf_edgeai_features_spectral_mask_t
 */
typedef enum nrf_edgeai_feature_freqdomain_e {
	...
	NRF_EDGEAI_FEATURE_DOM_FREQS_MEAN_DIST, /**< Distance between dominant frequency peaks */
...
/**
 * @brief Custom-domain features ID, should be kept in the same order as in
 * nrf_edgeai_features_spectral_mask_t
 */
...
typedef union nrf_edgeai_features_pipeline_u {
	/* Generic pointer */
	const void *p_void;
	/* Array of 8-bit pipeline functions */
	const nrf_edgeai_features_pipeline_func_i8_t *p_array_i8;
	/* Array of 16-bit pipeline functions */
	const nrf_edgeai_features_pipeline_func_i16_t *p_array_i16;
	/* Array of 32-bit pipeline functions */
	const nrf_edgeai_features_pipeline_func_f32_t *p_array_f32;
