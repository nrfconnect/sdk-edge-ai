 ...
 *
 * These functions transfer the output neuron values from the internal buffer
 * (of the corresponding data type) to the model output structure.
 * They may also apply any required post-processing such as activation or scaling.
 *
 ...
 *
 * These functions convert the output values from quantized format (8-bit or 16-bit) to 32-bit
 * floating point format, using the scaling parameters defined in the model context.
 *
 * @param[in, out] p_model    Pointer to model context @ref nrf_edgeai_model_t
 *
 * @note
 ...
 *
 * These functions convert the output values from quantized format (8-bit or 32-bit) to 32-bit
 * floating point format, using the scaling parameters defined in the model context.
 *
 * @param[in, out] p_model    Pointer to model context @ref nrf_edgeai_model_t
 *
