 ...
 *
 * These functions perform digital signal processing (DSP) feature extraction (such as statistical
 * or spectral features) from the input data. The extraction is performed according to the
 ...
 *  @param[in, out] p_dsp          Pointer to the DSP pipeline context @ref
