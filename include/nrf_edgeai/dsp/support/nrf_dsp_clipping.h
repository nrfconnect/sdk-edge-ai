 ...
 * @param[in]      min      Minimum limit for the input samples, all value below will be clipped to
 *                          this limit
 * @param[in]      max      Maximum limit for the input samples, all value above will be clipped to
 *                          this limit
 */
