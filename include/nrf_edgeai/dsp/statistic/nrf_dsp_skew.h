...
/**
 *
 * @defgroup nrf_dsp_statistic_skew Skewness
 * @{
 ...
 *
 */
#ifndef _NRF_DSP_STAT_SKEW_FUNCTIONS_H_
#define _NRF_DSP_STAT_SKEW_FUNCTIONS_H_
...
#endif /* _NRF_DSP_STAT_SKEW_FUNCTIONS_H_ */
