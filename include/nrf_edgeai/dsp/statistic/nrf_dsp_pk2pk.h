 ...
 */
flt32_t
nrf_dsp_pk2pk_hf_f32_s(const flt32_t *p_input, uint16_t num, size32_t stride, size32_t window_size);
 ...
 */
int16_t
nrf_dsp_pk2pk_hf_i8_s(const int8_t *p_input, uint16_t num, size32_t stride, size32_t window_size);
 ...
 */
int32_t
nrf_dsp_pk2pk_hf_i16_s(const int16_t *p_input, uint16_t num, size32_t stride, size32_t window_size);
 ...
 */
flt32_t
nrf_dsp_pk2pk_lf_f32_s(const flt32_t *p_input, uint16_t num, size32_t stride, size32_t window_size);
 ...
 */
int16_t
nrf_dsp_pk2pk_lf_i8_s(const int8_t *p_input, uint16_t num, size32_t stride, size32_t window_size);
 ...
 */
int32_t
nrf_dsp_pk2pk_lf_i16_s(const int16_t *p_input, uint16_t num, size32_t stride, size32_t window_size);
