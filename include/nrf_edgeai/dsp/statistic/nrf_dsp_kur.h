...
/**
 * @brief Calculate Excess Kurtosis of a floating-point vector ​​using values ​​in
 ...
 *                            context for further use
 *
 * @return  int16_t  Kurtosis value in integer format, not real value but with high correlation to
 * floating-point kurtosis
 */
 ...
 *                            context for further use
 *
 * @return  int32_t  Kurtosis value in integer format, not real value but with high correlation to
 * floating-point kurtosis
 */
