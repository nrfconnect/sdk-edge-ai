...
/**
 * @brief Calculates Percentage of signal over zero in a floating-point vector ​​using values
 ...
 * @param[in]   num       Number of samples in input vector
 *
 * @return  int16_t  Percentage of signal over zero in the vector, multiplied by
 * NRF_DSP_PERCENTAGE_TO_INT_FACTOR
 */
#define nrf_dsp_psoz_i8(p_input, num) nrf_dsp_psot_i8((p_input), (num), 0)

/**
 * @brief Calculates Percentage of signal over zero in a INT8 fixed-point vector ​​using values
 * ​​in increments of 'stride'.
 *
 * @param[in]   p_input   Pointer to the input vector
 * @param[in]   num       Number of samples with 'stride' in input vector
...
/**
 * @brief Calculates Percentage of signal over zero in a INT16 fixed-point vector ​​using values
 * ​​in increments of 'stride'.
 *
 * @param[in]   p_input   Pointer to the input vector
 * @param[in]   num       Number of samples with 'stride' in input vector
