...
/**
 * @brief Counts Mean-crossing rate of a floating-point vector ​​using values ​​in
 ...
 *                            for calculation if it exist
 *
 * @return  int16_t  Mean-crossing rate in the vector, multiplied by
 * NRF_DSP_PERCENTAGE_TO_INT_FACTOR
 */
int16_t nrf_dsp_mcr_i8(const int8_t *p_input, uint16_t num, nrf_dsp_stat_ctx_i8_t *p_ctx);

/**
 * @brief Counts Mean-crossing rate of a INT8 fixed-point vector ​​using values ​​in
 * increments of 'stride'.
 *
 * @param[in]       p_input   Pointer to the input vector
 * @param[in]       num       Number of samples with 'stride' in input vector
...
/**
 * @brief Counts Mean-crossing rate of a INT16 fixed-point vector ​​using values ​​in
 * increments of 'stride'.
 *
 * @param[in]       p_input   Pointer to the input vector
 * @param[in]       num       Number of samples with 'stride' in input vector
...
/**
 * @brief Counts Mean-crossing rate of a INT32 fixed-point vector ​​using values ​​in
 * increments of 'stride'.
 *
 * @param[in]   p_input   Pointer to the input vector
 * @param[in]   num       Number of samples with 'stride' in input vector
