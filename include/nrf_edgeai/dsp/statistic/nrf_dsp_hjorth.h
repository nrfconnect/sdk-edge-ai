...
typedef struct nrf_dsp_hjorth_params_f32_s {
	...
	/** Hjorth Mobility parameter represents the mean frequency or the proportion of standard
	 * deviation of the power spectrum. This is defined as the square root of variance of the
	 * first derivative of the signal y(t) divided by variance of the signal y(t).
	 */
	flt32_t mobility;
 ...
 *                            this function will use <pre> p_ctx->value.var </pre> for calculation
 *                            if it exist
 */
