...
/**
 * @brief Calculates Percentage of signal over Sigma with respect to Mean, in the floating-point
 * vector.
 *
 ...
 *                                  this function will use <pre> p_ctx->value.var and
 *                                  p_ctx->value.sum </pre> for calculation if it exist
 *
...
/**
 * @brief Calculates Percentage of signal over Sigma with respect to Mean, in the floating-point
 * vector ​​using values ​​in increments of 'stride'.
 *
 * @param[in]       p_input         Pointer to the input vector
...
/**
 * @brief Calculates Percentage of signal over Sigma with respect to Mean, in the INT8 fixed-point
 * vector.
 *
 * @param[in]       p_input         Pointer to the input vector
 * @param[in]       num             Number of samples in input vector
 ...
 *                                  p_ctx->value.sum </pre> for calculation if it exist
 *
 * @return  int16_t  Percentage of signal over Sigma in the vector, multiplied by
 ...
 *                                  p_ctx->value.sum </pre> for calculation if it exist
 *
 * @return  int16_t  Percentage of signal over Sigma in the vector within a stride, multiplied by
 * NRF_DSP_PERCENTAGE_TO_INT_FACTOR
 */
...
/**
 * @brief Calculates Percentage of signal over Sigma with respect to Mean, in the INT16 fixed-point
 * vector.
 *
 * @param[in]       p_input       Pointer to the input vector
 * @param[in]       num           Number of samples in input vector
