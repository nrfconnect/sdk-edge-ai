 ...
 *                       this function will use <pre> p_ctx->value.sum </pre> for
...
/**
 * @brief Calculate Absolute Mean value of a floating-point vector ​​using values ​​in
 ...
 * @param[in]   p_ctx     Optional pointer to the statistics context,
 *                        this function will use <pre> p_ctx->value.sum </pre> for calculation if it
 *                        exist
 *
 * @return  flt32_t  Absolute Mean value of the vector
 */
...
/**
 * @brief Calculate Absolute Mean value of a INT8 fixed-point vector ​​using values ​​in
 * increments of 'stride'.
 *
 * @param[in]  p_input   Pointer to the input vector
 * @param[in]  num       Number of samples with 'stride' in input vector
...
/**
 * @brief Calculate Absolute Mean value of a INT16 fixed-point vector ​​using values ​​in
 * increments of 'stride'.
 *
 * @param[in]   p_input   Pointer to the input vector
 * @param[in]   num       Number of samples with 'stride' in input vector
