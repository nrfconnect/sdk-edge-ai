 ...
 *                        the calculated value of tss and sum will be written
 *                        to context for further use
 *
 */
void nrf_dsp_tss_sum_f32(const flt32_t *p_input, uint16_t num, nrf_dsp_stat_ctx_f32_t *p_ctx);

/**
 * @brief Calculate Total Sum of Squares and Sum value of a floating-point vector ​​using values
...
/**
 * @brief Calculate Total Sum of Squares and Sum value of a INT8 fixed-point vector ​​using
...
/**
 * @brief Calculate Total Sum of Squares and Sum value of a INT16 fixed-point vector ​​using
 * values ​​in increments of 'stride'.
 *
 * @param[in]   p_input   Pointer to the input vector
 * @param[in]   num       Number of samples with 'stride' in input vector
