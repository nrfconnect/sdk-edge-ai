...
/**
 * @brief Finds Minimum value of a floating-point vector ​​using values ​​in increments of
 * 'stride'.
 *
 * @param[in]   p_input   Pointer to the input vector
...
/**
 * @brief Finds Minimum value of a INT8 fixed-point vector ​​using values ​​in increments of
 * 'stride'.
 *
 * @param[in]   p_input   Pointer to the input vector
 * @param[in]   num       Number of samples with 'stride' in input vector
...
/**
 * @brief Finds Minimum value of a INT16 fixed-point vector ​​using values ​​in increments
 * of 'stride'.
 *
 * @param[in]   p_input   Pointer to the input vector
 * @param[in]   num       Number of samples with 'stride' in input vector
...
/**
 * @brief Finds Minimum value of a INT32 fixed-point vector ​​using values ​​in increments
 * of 'stride'.
 *
 * @param[in]   p_input   Pointer to the input vector
 * @param[in]   num       Number of samples with 'stride' in input vector
