 ...
 *                                  this function will use <pre> p_ctx->value.var </pre> for
 *                                  calculation if it exist
 *
...
/**
 * @brief Counts Sigma-crossing rate with respect to Mean, of a floating-point vector ​​using
 ...
 *                                  calculation if it exist
 *
 * @return  int16_t  Sigma-crossing rate in the vector, multiplied by
...
/**
 * @brief Counts Sigma-crossing rate with respect to Mean, of a INT8 fixed-point vector ​​using
 * values ​​in increments of 'stride'.
 *
 * @param[in]       p_input         Pointer to the input vector
 * @param[in]       num             Number of samples with 'stride' in input vector
 ...
 *                                  calculation if it exist
 *
 * @return  int16_t  Sigma-crossing rate in the vector within a stride, multiplied by
 * NRF_DSP_PERCENTAGE_TO_INT_FACTOR
 */
...
/**
 * @brief Counts Sigma-crossing rate with respect to Mean, of a INT16 fixed-point vector ​​using
 * values ​​in increments of 'stride'.
 *
 * @param[in]       p_input         Pointer to the input vector
 * @param[in]       num             Number of samples with 'stride' in input vector
