 ...
 *                            this function will use <pre> p_ctx->value.tss </pre> for calculation
 *                            if it exist
 *
...
/**
 * @brief Calculates Crest Factor (Peak to RMS) in a floating-point vector ​​using values
 ...
 *                            if it exist
 *
 * @return  int16_t  Crest Factor (Peak to RMS) in the vector, multiplied by
 * NRF_DSP_FLOAT_TO_INT_FACTOR
 */
...
/**
 * @brief Calculates Crest Factor (Peak to RMS) in a INT8 fixed-point vector ​​using values
 * ​​in increments of 'stride'.
 *
 * @param[in]       p_input   Pointer to the input vector
 * @param[in]       num       Number of samples with 'stride' in input vector
...
/**
 * @brief Calculates Crest Factor (Peak to RMS) in a INT16 fixed-point vector ​​using values
 * ​​in increments of 'stride'.
 *
 * @param[in]       p_input   Pointer to the input vector
 * @param[in]       num       Number of samples with 'stride' in input vector
