...
/**
 *
 * @defgroup nrf_dsp_statistic_amdf Average Magnitude Difference
 * @{
 ...
 *
 */
#ifndef _NRF_DSP_STAT_AMDF_FUNCTIONS_H_
#define _NRF_DSP_STAT_AMDF_FUNCTIONS_H_
 ...
 *
 * @return  flt32_t  Average Magnitude Difference value in the vector
 */
flt32_t nrf_dsp_amdf_f32(const flt32_t *p_input, uint16_t num);

/**
 * @brief Calculates Average Magnitude Difference value of a floating-point vector ​​using
 ...
 * @param[in]   num       Number of samples in input vector
 *
 * @return  int16_t  Average Magnitude Difference value in the vector
 */
int16_t nrf_dsp_amdf_i8(const int8_t *p_input, uint16_t num);

/**
 * @brief Calculates Average Magnitude Difference value of a INT8 fixed-point vector ​​using
 * values ​​in increments of 'stride'.
 *
 * @param[in]   p_input   Pointer to the input vector
 * @param[in]   num       Number of samples with 'stride' in input vector
 ...
 * @param[in]   num       Number of samples in input vector
 *
 * @return  int32_t  Average Magnitude Difference value in the vector
 */
int32_t nrf_dsp_amdf_i16(const int16_t *p_input, uint16_t num);

/**
 * @brief Calculates Average Magnitude Difference value of a INT16 fixed-point vector ​​using
 * values ​​in increments of 'stride'.
 *
 * @param[in]   p_input   Pointer to the input vector
 * @param[in]   num       Number of samples with 'stride' in input vector
...
#endif /* _NRF_DSP_STAT_AMDF_FUNCTIONS_H_ */
