...
/**
 *
 * @defgroup nrf_dsp_statistic_rds Root Difference Square
 * @{
 ...
 *
 */
#ifndef _NRF_DSP_STAT_RDS_FUNCTIONS_H_
#define _NRF_DSP_STAT_RDS_FUNCTIONS_H_
...
#endif /* _NRF_DSP_STAT_RDS_FUNCTIONS_H_ */
