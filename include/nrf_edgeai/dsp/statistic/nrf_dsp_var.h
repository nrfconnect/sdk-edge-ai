...
/**
 * @brief Calculate Variance value of a floating-point vector ​​using values ​​in increments
 * of 'stride'.
 * @details This function uses internal accumulator of flt32_t size,
 *          for calculating sum of squares of values, so it will lose precision if
 *          values ​​less than 10e-4
 ...
 * @param[in]   p_input            Pointer to the input vector
 * @param[in]   num                Number of samples in input vector
 * @param[out]  p_deriv_variance   Calculated derivatives of variance
 */
...
/**
 * @brief Calculate Variance value of a INT8 fixed-point vector ​​using values ​​in
...
/**
 * @brief Calculate Variance value of a INT16 fixed-point vector ​​using values ​​in
 * increments of 'stride'.
 *
 * @param[in]        p_input   Pointer to the input vector
 * @param[in]        num       Number of samples with 'stride' in input vector
