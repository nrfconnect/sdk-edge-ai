 ...
 *
 * @param[in]   p_input          Input array and the data is stored in an interleaved fashion
 *                               [xR0, xI0, xR1, xI1, ..., xRn, xIn]. The input array should has a
 *                               total of <code>2*num</code> values
...
/**
 * @brief   Computes the magnitude of the elements of a complex data vector in ingeter 16-bit
 * format.
 *
 * @param[in]   p_input          Input array and the data is stored in an interleaved fashion
 *                               [xR0, xI0, xR1, xI1, ..., xRn, xIn]. The input array should has a
