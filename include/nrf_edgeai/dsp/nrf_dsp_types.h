...
/**
 * @brief  Floating-point statistics reusable context, in which is used to store derived or
 * intermediate metrics to simplify / speed up the calculation of dependent metrics
 */
...
/**
 * @brief Floating-point spectral reusable context, in which is used to store derived or
 * intermediate metrics to simplify / speed up the calculation of dependent metrics
 *
 */
...
/**
 * @brief INT16-fixed-point spectral reusable context, in which is used to store derived or
 * intermediate metrics to simplify / speed up the calculation of dependent metrics
 *
 */
