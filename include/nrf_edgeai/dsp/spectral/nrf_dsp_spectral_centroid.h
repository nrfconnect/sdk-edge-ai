 ...
 *
 * @brief The spectral centroid represents the "center of mass" of the frequency content in a
 * vibration signal, indicating the average frequency where most of the signal's energy is
 * concentrated. It provides insight into the distribution of energy across different frequency
 * bands.
 *
 */
