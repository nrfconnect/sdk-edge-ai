 ...
 * @param[in] base_freq_index           Frequency index(bin) in amplitude spectrum for which THD
 *                                      will be computed
 * @param[in] n_harmonics               Number of harmonics to compute THD, starting from second
 *                                      one, e.g. n_harmonics = 3 then
 *                                      for THD will be used H_2x, H_3x, H_4x
 *
