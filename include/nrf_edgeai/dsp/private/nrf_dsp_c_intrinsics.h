...
{
	bool overflow = ((int32_t)(x >> 32) != ((int32_t)x >> 31));

	return overflow ? ((0x7FFFFFFF ^ ((int32_t)(x >> 63)))) : (int32_t)x;
}
...
__NRF_DSP_STATIC_FORCEINLINE int16_t clip_q63_to_q15(int64_t x)
{
	...
	return overflow ? ((0x7FFF ^ ((int16_t)(x >> 63)))) : (int16_t)(x >> 15);
}
...
{
	bool overflow = ((int32_t)(x >> 24) != ((int32_t)x >> 23));

	return overflow ? ((0x7F ^ ((int8_t)(x >> 31)))) : (int8_t)x;
}
...
{
	bool overflow = ((int32_t)(x >> 16) != ((int32_t)x >> 15));

	return overflow ? ((0x7FFF ^ ((int16_t)(x >> 31)))) : (int16_t)x;
}
