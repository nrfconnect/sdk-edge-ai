 ...
 * @param[in]       uniq_features_num   Number of unique features in feature sample, e.g feature
 *                                      sample = {x, y, z}, then uniq_features_num = 3
 *
 ...
 *                              should be initialized first @ref nrf_dsp_window_flatten_init
 * @param[in]       p_input     Pointer to the feature sample buffer
 * @param[in]       num         Number of samples in the input buffer,
 *                              num = buffer_size / p_ctx->uniq_features_num
 *
