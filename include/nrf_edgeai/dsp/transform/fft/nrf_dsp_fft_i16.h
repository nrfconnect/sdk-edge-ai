 ...
 *
 * @param[in, out]  p_rfft              Pointer to instance of real FFT structure to initialize @ref nrf_dsp_rfft_i16_t
 * @param[in]       len                 Length of the real FFT
 * @param[in]       p_twiddle_rfft      Pointer to the Real Twiddle factor table, can be generated with @ref nrf_dsp_rfft_twiddle_factors_i16
 * @param[in]       p_twiddle_cfft      Pointer to the Twiddle factor table, can be generated with @ref nrf_dsp_cfft_twiddle_factors_i16
 ...
 *
 * @param[in, out]  p_cfft              Pointer to instance of complex FFT structure to initialize @ref nrf_dsp_cfft_i16_t
 ...
 * @param[in]       bitreverse_flag     Flag that enables (bitreverse_flag=1) or disables(bitreverse_flag=0) bit reversal of output
 */
 ...
 *          The algorithm supports lengths of [16, 64, 256, 1024, 4096] and each length uses a different
 ...
 * 
 * @param[out] p_twiddle_cfft       Output complex twiddle factors buffer, the output buffer should be 3*fft_len/2 in length
