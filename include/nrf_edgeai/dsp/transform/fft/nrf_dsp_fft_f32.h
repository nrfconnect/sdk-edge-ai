 ...
 * @param[in]       p_twiddle_rfft      Pointer to the Real Twiddle factor table,
 *                                      can be generated with @ref nrf_dsp_rfft_twiddle_factors_f32
 * @param[in]       p_twiddle_cfft      Pointer to the Twiddle factor table,
 *                                      can be generated with @ref nrf_dsp_cfft_twiddle_factors_f32
 ...
 *                          nrf_dsp_cfft_radix8by2_f32, nrf_dsp_cfft_radix8by4_f32 or
 ...
 * @param[in]       bitreverse_flag     Flag that enables (bitreverse_flagR=1) or
 *                                      disables(bitreverse_flagR=0) bit reversal of output
 */
 ...
 * @param[in]       p_cfft              Pointer to instance of complex FFT structure
 * @param[in, out]  p_input             Pointer to buffer with input samples
 * @param[in]       bitreverse_flag     Flag that enables (bitreverse_flagR=1) or disables
 *                                      (bitreverse_flagR=0) bit reversal of output
...
/**
 * @brief   The floating-point complex FFT uses a radix-8 algorithm.
 ...
 *                              be 2*fft_len in length the twiddle factors will be written in
 ...
 *
 * @param[out] p_twiddle_rfft   Output real twiddle factors buffer, the output buffer should be
 *                              fft_len in length the twiddle factors will be written in
 *                              interleaved fashion (cos0,sin0,cos1,sin1,..., cosN,sinN),
 * @param[in]  fft_len          FFT length for which twiddle factors table will be  generated,
