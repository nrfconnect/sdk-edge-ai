...
/*
 * register write to axon nn primitive.
 * returns:
 ...
 */
extern int axon_nn_simulator_write_reg_prim(
	volatile NRF_AXON_PLATFORM_BITWIDTH_UNSIGNED_TYPE *addr,
	NRF_AXON_PLATFORM_BITWIDTH_UNSIGNED_TYPE value);

extern int axon_dsp_simulator_write_reg_prim(
	volatile NRF_AXON_PLATFORM_BITWIDTH_UNSIGNED_TYPE *addr,
	NRF_AXON_PLATFORM_BITWIDTH_UNSIGNED_TYPE value);

extern NRF_AXON_PLATFORM_BITWIDTH_UNSIGNED_TYPE axon_dsp_simulator_read_reg_prim(
	volatile NRF_AXON_PLATFORM_BITWIDTH_UNSIGNED_TYPE *addr);

extern NRF_AXON_PLATFORM_BITWIDTH_UNSIGNED_TYPE axon_nn_simulator_read_reg_prim(
	volatile NRF_AXON_PLATFORM_BITWIDTH_UNSIGNED_TYPE *addr);
...
*/
extern int axon_dsp_simulator_process_action_request(
	int *check_cfg_err,
	uint64_t *o_cycles,
	int *o_wdog_cmd,
	int *o_wdog_finish);

extern int axon_nn_simulator_process_action_request(
	int *check_cfg_err,
	uint64_t *o_cycles,
	int *o_wdog_cmd,
	int *o_wdog_finish);
...
int read_in_test_vector_int8(
	FILE * src_file,
	int8_t *test_vector_buffer,
	uint32_t buffer_length);
int read_in_test_vector_int16(
	FILE * src_file,
	int16_t *test_vector_buffer,
	uint32_t buffer_length);
