...
#error "NRF_MODEL_PARTITION_ADDR must be defined when compiling model_ota_edgeai_axon_wired.c"
#endif
...
#define MODEL_OTA_EDGEAI_AXON_CONTRACT_HASH                                                        \
	MODEL_OTA_CONTRACT_HASH_EDGEAI_AXON(MODEL_OTA_PARTITION_ADDR(MODEL_OTA_PARTITION_NODELABEL), \
