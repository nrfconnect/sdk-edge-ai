 ...
 *   and MODEL_OTA_NEUTON_NEURONS_CAP; defines nrf_edgeai_load_user_model_<SOLUTION_ID>().
 *
 ...
 *   lib/model_ota/src/model_ota_edgeai_axon_wired.c compiled once per solution with -D defines;
 *   defines nrf_edgeai_load_user_model_<SOLUTION_ID>() (declared via model_ota_edgeai.h).
 *
 * Raw Axon app wired (model_ota_axon_model):
 *   lib/model_ota/src/model_ota_axon_wired.c compiled once per TARGET with -D defines;
 *   defines model_ota_load_axon_<TARGET>() (declared via model_ota_axon.h).
 *
