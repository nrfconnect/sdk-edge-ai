...
if(DEFINED MODEL_FIXUPS_HEADER)
  list(APPEND validate_layout_args --fixups-header ${MODEL_FIXUPS_HEADER})
endif()

list(APPEND validate_layout_args --defs-header ${PARTITION_DEFS_HEADER})

execute_process(
  COMMAND ${validate_layout_args}
  COMMAND_ERROR_IS_FATAL ANY
)
